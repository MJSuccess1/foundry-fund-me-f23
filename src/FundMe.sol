...
contract FundMe {
    ...
    mapping(address => uint256) private s_addressToAmountFunded; //storage var gotta start with s_
    ...
    function cheaperWithdraw() public onlyOwner {
        ...
        s_funders = new address[](0); //resseting storage
    ...
    function getOwner() external view returns (address) { //just created this during "More Coverage" video
        return i_owner;
    }
